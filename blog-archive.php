...
<body>
    ...
    <section id="blogArchive">      
	    ...
	    <div class="row"><div class="col-lg-12 col-md-12"><div class="container"><div class="row"><div class="col-md-12 col-sm-12">
        	...
        	<div class="blogArchive-area"><div class="row">
        		<!-- Start Blog Content -->
        		<div class="col-md-9 col-sm-8">
            		<div class="blog-content">
                        ...
                        <div class="single-Blog">
                            ...
                            <div class="blog-content">
                              	<h2>Latest Trend Of Technology</h2>
                ...
                <div class="col-md-3 col-sm-4"><aside class="sidebar">
                    <!-- Begin sidebar widget Latest Post -->
                    ...
                    <!-- End Sidebar Widget Latest Post -->
                    <!-- Start sidebar widget tags -->
                    <div class="sidebar-widget">
                      	<h3>Tags</h3>
                      	<ul class="tag-nav">
