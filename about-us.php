...
<body>
          ...
          <div class="blog-breadcrumbs-area">
            <div class="container">
              ...
              <div class="blog-breadcrumbs-right">
                <ol class="breadcrumb">
                  <li><a href="#" id="button-manajemen">Manajemen</a></li>
                  <li><a href="#" id="button-teknisi">Teknisi</a></li>
                  <li><a href="#" id="button-supervisi">Supervisi</a></li>
                </ol>
              </div>
            </div>
          </div>
    ...
    <section id="meetDoctors">
      <div class="container">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <!-- Begin Manajemen -->
            <div class="meetDoctors-area" id="manajemen">
            ...
            <!-- End Manajemen -->
            <!-- Begin Teknisi -->
            <div class="meetDoctors-area" id="teknisi">
              <div class="section-heading">
                <h2>Tim Teknisi</h2>
                <div class="line"></div>
                <p class="text-justify">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
            ...
            <!-- End Teknisi -->
            <!-- Begin Supervisi -->
            <div class="meetDoctors-area" id="supervisi">
             <!-- Start Service Title -->
              <div class="section-heading">
                <h2>Tim Supervisi</h2>
                <div class="line"></div>
    ...
    <script>
      $(document).ready(
        function(){
            $("#button-manajemen").click(function(){
              $("#manajemen").show();
              $("#teknisi").hide();
              $("#supervisi").hide();
            });
            $("#button-teknisi").click(function(){
              $("#manajemen").hide();
              $("#teknisi").show();
              $("#supervisi").hide();
            });
            $("#button-supervisi").click(function(){
              $("#manajemen").hide();
              $("#teknisi").hide();
              $("#supervisi").show();
            });
